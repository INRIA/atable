...
This repository contains the accompying code of the following ACM CHI 2014 article.
...
An [online demo](http://charles.perin.free.fr/atable/) is also available. Here is a summary of the project:
